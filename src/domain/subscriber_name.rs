...
// claim crate needs our type to implement the Debug trait to provide those nice error messages.
#[derive(Debug)]
// tuple struct
...
impl SubscriberName {
    ...
    // Note, this is the same as using AsRef<T> which is part of the standard lib.
    // we'll opt to use that instead and keep this for educational purposes
